            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="dropdown ms-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                        ...
                        <li><a class="dropdown-item" href="countries?show=North%20America">North America</a></li>
                        <li><a class="dropdown-item" href="countries?show=South%20America">South America</a></li>
                    </ul>
                </div>
                <div class="dropdown ms-3">
